...
export class ProgramDetailsComponent implements OnInit{
  @ViewChild(GProgramComponent, { static: false })
  gComponent: GProgramComponent;
  @ViewChild(IProgramComponent, { static: false })
  iComponent: IProgramComponent;
    ...
    this.route.params.subscribe((val) => {
      ...
      this.services
        ...
        .subscribe((program) => {
          ...
          this.viewImgHref =
            AppConstants.EXPRESS_SERVER_URL + this.programData.ImgData;
          if (this.programData.ProgramType === AppConstants.PROGRAM_TYPE_CODE.GROUP_PROGRAM) {
            this.ProgramTypeText = AppConstants.PROGRAM_TEXT.GROUP_PROGRAM;
            this.programTypeShortText = 'g';
          } else {
            this.ProgramTypeText = AppConstants.PROGRAM_TEXT.INDIVIDUAL_PROGRAM;
  ...
  submit() {
    ...
    this.services
      .updateProgramHeader(this.getFormData())
      .subscribe((result) => {
        this.services
          .updateProgramLayoutDetails(
            this.programTypeShortText,
            this.bookingRequirementData
          )
          .subscribe((res) => {
